...
%\include{sunquakes-intro} %Introduction

%%%UPGRADE REWRITE
%\include{all-sections}
%\include{thesis-intro-rewrite-full} %Introduction
\include{thesis-intro-rewrite} %Introduction
%\include{lit-review}%sunquake literature review
\include{data-and-methodology}
\include{results}
\include{interpretation-and-discussion}
%\include{conclusions-and-thesis-plan}
\include{intro-appendix}


%\include{sunquake-model}
%\include{progenitors-of-sunquakes}
%\include{eruptive-solar-flares}
%\include{observable-seismic-signatures}
%\include{mhd}
%\include{projectupgrd}
