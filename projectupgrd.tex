...
Using the \texttt{ospex} software within SolarSoft (SSWIDL), count data from RHESSI is fit to thermal and non-thermal electron energy models. %insert rhessi section from that paper
